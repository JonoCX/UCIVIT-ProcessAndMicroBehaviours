...
echo starting ExtractBehaviours at $(timestamp)
...
##Which micro behaviour collections should be extracted?
extractScroll=false
extractMouseskinny=true
extractMousemove=true
...
if [ "$extractScroll" = true ] ; then
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo $mongoPath --eval "load('ExtractUserScrollBehaviour.js');printScrollStatisticsBatchedPerUser(0,25);" > data/scrollStatistics_0-25.json
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printScrollStatisticsBatchedPerUser(25,50);" > data/scrollStatistics_25-50.json
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printScrollStatisticsBatchedPerUser(50,75);" > data/scrollStatistics_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printScrollStatisticsBatchedPerUser(75,100);" > data/scrollStatistics_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printScrollEpisodeDurationBatchedPerUser(0,25);" > data/scrollEpisodeDuration_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printScrollEpisodeDurationBatchedPerUser(25,50);" > data/scrollEpisodeDuration_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printScrollEpisodeDurationBatchedPerUser(50,75);" > data/scrollEpisodeDuration_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printScrollEpisodeDurationBatchedPerUser(75,100);" > data/scrollEpisodeDuration_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printControlledScrollBatchedPerUser(0,25);" > data/scrollControlledScrollBehaviour_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printControlledScrollBatchedPerUser(25,50);" > data/scrollControlledScrollBehaviour_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printControlledScrollBatchedPerUser(50,75);" > data/scrollControlledScrollBehaviour_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printControlledScrollBatchedPerUser(75,100);" > data/scrollControlledScrollBehaviour_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printControlledScrollSummaryBatchedPerUser(0,25);" > data/scrollControlledScrollBehaviourSummary_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printControlledScrollSummaryBatchedPerUser(25,50);" > data/scrollControlledScrollBehaviourSummary_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printControlledScrollSummaryBatchedPerUser(50,75);" > data/scrollControlledScrollBehaviourSummary_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printControlledScrollSummaryBatchedPerUser(75,100);" > data/scrollControlledScrollBehaviourSummary_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastMouseScrollCycleBatchedPerUser(0,25);" > data/scrollFastMouseScrollCycleBehaviour_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastMouseScrollCycleBatchedPerUser(25,50);" > data/scrollFastMouseScrollCycleBehaviour_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastMouseScrollCycleBatchedPerUser(50,75);" > data/scrollFastMouseScrollCycleBehaviour_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastMouseScrollCycleBatchedPerUser(75,100);" > data/scrollFastMouseScrollCycleBehaviour_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastMouseScrollCycleSummaryBatchedPerUser(0,25);" > data/scrollFastMouseScrollCycleBehaviourSummary_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastMouseScrollCycleSummaryBatchedPerUser(25,50);" > data/scrollFastMouseScrollCycleBehaviourSummary_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastMouseScrollCycleSummaryBatchedPerUser(50,75);" > data/scrollFastMouseScrollCycleBehaviourSummary_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastMouseScrollCycleSummaryBatchedPerUser(75,100);" > data/scrollFastMouseScrollCycleBehaviourSummary_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastSingleDirectionMouseScrollBatchedPerUser(0,25);" > data/scrollFastSingleDirectionMouseScroll_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastSingleDirectionMouseScrollBatchedPerUser(25,50);" > data/scrollFastSingleDirectionMouseScroll_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastSingleDirectionMouseScrollBatchedPerUser(50,75);" > data/scrollFastSingleDirectionMouseScroll_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastSingleDirectionMouseScrollBatchedPerUser(75,100);" > data/scrollFastSingleDirectionMouseScroll_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastSingleDirectionMouseScrollSummaryBatchedPerUser(0,25);" > data/scrollFastSingleDirectionMouseScrollSummary_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastSingleDirectionMouseScrollSummaryBatchedPerUser(25,50);" > data/scrollFastSingleDirectionMouseScrollSummary_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastSingleDirectionMouseScrollSummaryBatchedPerUser(50,75);" > data/scrollFastSingleDirectionMouseScrollSummary_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserScrollBehaviour.js');printFastSingleDirectionMouseScrollSummaryBatchedPerUser(75,100);" > data/scrollFastSingleDirectionMouseScrollSummary_75-100.json  
   else
...
##################MOUSE BEHAVIOURS
if [ "$extractMouseskinny" = true ] ; then
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseStatisticsBatchedPerUser(0,25);" > data/mouseStatistics_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseStatisticsBatchedPerUser(25,50);" > data/mouseStatistics_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseStatisticsBatchedPerUser(50,75);" > data/mouseStatistics_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseStatisticsBatchedPerUser(75,100);" > data/mouseStatistics_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseEpisodeDurationBatchedPerUser(0,25);" > data/mouseEpisodeDuration_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseEpisodeDurationBatchedPerUser(25,50);" > data/mouseEpisodeDuration_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseEpisodeDurationBatchedPerUser(50,75);" > data/mouseEpisodeDuration_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseEpisodeDurationBatchedPerUser(75,100);" > data/mouseEpisodeDuration_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printClickSpeedBatchedPerUser(0,25);" > data/mouseClickSpeed_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printClickSpeedBatchedPerUser(25,50);" > data/mouseClickSpeed_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printClickSpeedBatchedPerUser(50,75);" > data/mouseClickSpeed_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printClickSpeedBatchedPerUser(75,100);" > data/mouseClickSpeed_75-100.json  
   else
   ...
   ######END OF BATCHED mouse ClickSpeed
      ...
      #ongoAuthenticateDB --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseIdleTime();" > data/mouseIdleTime.json
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseIdleTimeBatchedPerUser(0,25);" > data/mouseIdleTime_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseIdleTimeBatchedPerUser(25,50);" > data/mouseIdleTime_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseIdleTimeBatchedPerUser(50,75);" > data/mouseIdleTime_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printMouseIdleTimeBatchedPerUser(75,100);" > data/mouseIdleTime_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printTimeToClickBatchedPerUser(0,25);" > data/mouseTimeToClick_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printTimeToClickBatchedPerUser(25,50);" > data/mouseTimeToClick_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printTimeToClickBatchedPerUser(50,75);" > data/mouseTimeToClick_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printTimeToClickBatchedPerUser(75,100);" > data/mouseTimeToClick_75-100.json  
   else
   ...
   ######END OF BATCHED mouse TimeToClick
      ...
      #ongoAuthenticateDB --eval "load('ExtractUserMouseBehaviourSkinny.js');printHoveringOver();" > data/mouseHoveringOver.json
   #echo Printing Out User mouse HoveringOver to file at $(timestamp)
      ...
      #ongoAuthenticateDB --eval "load('ExtractUserMouseBehaviourSkinny.js');printUnintentionalMousemovement();" > data/mouseUnintentionalMousemovement.json
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickBatchedPerUser(0,25);" > data/mouseFailToClick_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickBatchedPerUser(25,50);" > data/mouseFailToClick_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickBatchedPerUser(50,75);" > data/mouseFailToClick_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickBatchedPerUser(75,100);" > data/mouseFailToClick_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printIdleAfterClickBatchedPerUser(0,25);" > data/mouseIdleAfterClick_0-25.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printIdleAfterClickBatchedPerUser(25,50);" > data/mouseIdleAfterClick_25-50.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printIdleAfterClickBatchedPerUser(50,75);" > data/mouseIdleAfterClick_50-75.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printIdleAfterClickBatchedPerUser(75,100);" > data/mouseIdleAfterClick_75-100.json  
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printLackOfMousePrecisionBatchedPerUser(0,25);" > data/mouseLackOfMousePrecision_0-25.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printLackOfMousePrecisionBatchedPerUser(25,50);" > data/mouseLackOfMousePrecision_25-50.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printLackOfMousePrecisionBatchedPerUser(50,75);" > data/mouseLackOfMousePrecision_50-75.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printLackOfMousePrecisionBatchedPerUser(75,100);" > data/mouseLackOfMousePrecision_75-100.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printRepeatedClicksBatchedPerUser(0,25);" > data/mouseRepeatedClicks_0-25.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printRepeatedClicksBatchedPerUser(25,50);" > data/mouseRepeatedClicks_25-50.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printRepeatedClicksBatchedPerUser(50,75);" > data/mouseRepeatedClicks_50-75.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printRepeatedClicksBatchedPerUser(75,100);" > data/mouseRepeatedClicks_75-100.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickDiffNodeBatchedPerUser(0,25);" > data/mouseFailToClickDiffNode_0-25.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickDiffNodeBatchedPerUser(25,50);" > data/mouseFailToClickDiffNode_25-50.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickDiffNodeBatchedPerUser(50,75);" > data/mouseFailToClickDiffNode_50-75.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickDiffNodeBatchedPerUser(75,100);" > data/mouseFailToClickDiffNode_75-100.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickIgnoreNodeBatchedPerUser(0,25);" > data/mouseFailToClickIgnoreNode_0-25.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickIgnoreNodeBatchedPerUser(25,50);" > data/mouseFailToClickIgnoreNode_25-50.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickIgnoreNodeBatchedPerUser(50,75);" > data/mouseFailToClickIgnoreNode_50-75.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printFailToClickIgnoreNodeBatchedPerUser(75,100);" > data/mouseFailToClickIgnoreNode_75-100.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printClickAfterLoadBatchedPerUser(0,25);" > data/mouseClickAfterLoad_0-25.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printClickAfterLoadBatchedPerUser(25,50);" > data/mouseClickAfterLoad_25-50.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printClickAfterLoadBatchedPerUser(50,75);" > data/mouseClickAfterLoad_50-75.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseBehaviourSkinny.js');printClickAfterLoadBatchedPerUser(75,100);" > data/mouseClickAfterLoad_75-100.json     
   else
...
if [ "$extractMousemove" = true ] ; then
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveStatisticsBatchedPerUser(0,25);" > data/mouseMoveStatistics_0-25.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveStatisticsBatchedPerUser(25,50);" > data/mouseMoveStatistics_25-50.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveStatisticsBatchedPerUser(50,75);" > data/mouseMoveStatistics_50-75.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveStatisticsBatchedPerUser(75,100);" > data/mouseMoveStatistics_75-100.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveEpisodeDurationBatchedPerUser(0,25);" > data/mouseMoveEpisodeDuration_0-25.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveEpisodeDurationBatchedPerUser(25,50);" > data/mouseMoveEpisodeDuration_25-50.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveEpisodeDurationBatchedPerUser(50,75);" > data/mouseMoveEpisodeDuration_50-75.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveEpisodeDurationBatchedPerUser(75,100);" > data/mouseMoveEpisodeDuration_75-100.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveBatchedPerUser(0,25);" > data/mouseMove_0-25.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveBatchedPerUser(25,50);" > data/mouseMove_25-50.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveBatchedPerUser(50,75);" > data/mouseMove_50-75.json     
   else
   ...
   if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
      mongo --eval "load('ExtractUserMouseMoveBehaviour.js');printMouseMoveBatchedPerUser(75,100);" > data/mouseMove_75-100.json     
   else
...
if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
   mongo --eval "load('ExtractUrlMetrics.js');printUrlMetricsBatchedPerUser(0,25);" > data/urlMetrics_0-25.json     
else
...
if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
   mongo --eval "load('ExtractUrlMetrics.js');printUrlMetricsBatchedPerUser(25,50);" > data/urlMetrics_25-50.json     
else
...
if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
   mongo --eval "load('ExtractUrlMetrics.js');printUrlMetricsBatchedPerUser(50,75);" > data/urlMetrics_50-75.json     
else
...
if [ "$mongoUser" = "USERNAME" ] || [ "$mongoUser" = "" ];then 
   mongo --eval "load('ExtractUrlMetrics.js');printUrlMetricsBatchedPerUser(75,100);" > data/urlMetrics_75-100.json     
else
...
echo finished ExtractBehaviours at $(timestamp)